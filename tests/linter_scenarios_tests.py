...
'''
        EXPECTED_DIAGNOSTICS = [
            ExpectedDiagnostic(
                line=3,
                code="TYP010",
                message="Use 'dict[str, list[int]] | None' instead of 'Optional[Dict[str, List[int]]]'"
            ),
        ]
...
'''
        EXPECTED_DIAGNOSTICS = [
            ExpectedDiagnostic(
                line=1,
                code="KW001",
                message="Function 'create_user' should use keyword-only parameters (add * separator)"
            ),
        ]
...
'''
        EXPECTED_DIAGNOSTICS = [
            ExpectedDiagnostic(
                line=2,
                code="KW001",
                message="Method 'compute' should use keyword-only parameters (add * separator)"
            ),
        ]
...
'''
        EXPECTED_DIAGNOSTICS = [
            ExpectedDiagnostic(
                line=2,
                code="RET001",
                message="Avoid tuple packing for return values; use a dataclass or NamedTuple"
            ),
        ]
...
'''
        EXPECTED_DIAGNOSTICS = [
            ExpectedDiagnostic(
                line=2,
                code="IMP001",
                message="Import 'pathlib.Path' should be at module level, not inside function"
            ),
        ]
...
'''
        EXPECTED_DIAGNOSTICS = [
            ...
            ExpectedDiagnostic(
                line=4,
                code="IMP001",
                message="Import 'datetime.datetime' should be at module level, not inside function"
            ),
        ]
...
'''
        EXPECTED_DIAGNOSTICS = [
            ExpectedDiagnostic(
                line=4,
                code="EXP001",
                message="Return type 'Result' should be defined at module level for importability"
            ),
        ]
...
def assert_diagnostics_match(
    ...
    """
    Helper function to assert that actual diagnostics match expected ones.
